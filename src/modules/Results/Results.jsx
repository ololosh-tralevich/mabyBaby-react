...
import {getTestType,getTestResult} from '../../redux/qaTests/qaTests-selectors'
...
const Results = () => {
  ...
  const correctAnswers=(Math.round((result.result.replace("%","")*12)/100));
